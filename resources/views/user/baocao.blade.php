...
<div class="recommended_items">
    <!--recommended_items-->
    <h2 class="title text-center">Sự cố về máy tính</h2>
    ...
    @csrf
        ...
        <div class="form-group">
            ...
            <input type="email" class="form-control" id="exampleFormControlInput1" name="nsx" placeholder="Vui lòng nhập nếu bạn biết">
        </div>
        <div class="form-group">
